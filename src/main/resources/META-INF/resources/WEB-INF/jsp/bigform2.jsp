...
<div>
<input type="checkbox" name="langs" id="symp1" value="Headache and nausea" checked> <label for="langs_javascript">Red spots all over body</label>
</div>
<div>
<input type="checkbox" name="langs" id="symp2" value="Bodypain"> <label for="langs_perl">sickness</label>
</div>
<div>
<input type="checkbox" name="langs" id="symp3" value="Diarhea" > <label for="langs_php">loss of weight</label>
</div>
<div>
<input type="checkbox" name="langs" id="symp4" value="Blindness"> <label for="langs_ruby">Blindness</label>
</div>
